...
**Type:**  58 questions answered by 4,042 participants, survey data with mixed data types
...
**Source Code:** Core functions and modules are stored in src/.
**Analysis:** Execute the Jupyter notebooks available in the notebooks/ directory.
